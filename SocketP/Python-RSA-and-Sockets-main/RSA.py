...
def private_key_digital_signature(private_key):
    ...
    valid_key_message = "Esta mensagem foi encriptada com minha chave privada, ela apenas pode ser decriptografada com minha chave publica. Se voce consegue compreender isto, significa que a chave utilizada para decriptografar foi a minha chave publica, logo a comunicacao esta segura."
